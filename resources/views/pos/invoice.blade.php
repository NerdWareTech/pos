		...
		<div id="invoice-POS">
	    	...
	    	<div id="bot">
				...
				<div id="legalcopy" style="padding-bottom: 10px;">
					...
					<p>
					<br><br>
					1) Exchange within 7 days from the date of purchase.<br>
					2) Items must be in original packaging with label attached.<br>
					3) No Exchange on Sale Items/Discounted Items.<br>
					4) Exchange with original receipt showing the listed items.<br>
					5) No Refund, No Return only Exchange.<br><br><br>
					</p>
			...
			<div style="text-align: center;  font-size: 10px; color: black;">
				A Software By NerdWare Tech Pvt. Ltd.
				<br>
				+92 3038126439, nerdwaretech@outlook.com
			</div>
	  	</div><!--End Invoice-->
