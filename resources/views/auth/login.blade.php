        ...
        <div class="center-content row">
            ...
            <div>
                <center>
                  ...
                  @else
                  <img src="/img/nerdware.png" class="wow fadeIn">
                  @endif
                </center>
                <br>
                        ...
                        <div class="content-box-wrapper">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="email" value="poshwearstudio@gmail.com">
                                </div>
                            </div>
